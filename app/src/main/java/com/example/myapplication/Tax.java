...
public class Tax implements Serializable {
    private Double PRSI, hours, rate, gross, paye, usc,netpay, taxCredit, healthInsurance, unionSubs, overTime, taxablePay;
...
//default constractor
    public Tax() { //set initial values too zero
        hours = 0.0;
        rate = 0.0;
        PRSI = 0.0;
        gross = 0.0;
    ...
    public Double gross() {
        return gross = hours * rate;// create formula to calculate gross for week
    }
    public Double gross1() {
        Double gross1;
        return gross1=gross *4.0;// create formula to calculate gross for month
    }
    public Double gross2() {
        Double gross2;
        return gross2= gross*52.0;// create formula to calculate gross for year
    }
    ...
    public Double taxablePay1() {
        return (taxablePay) *4;// create formula to calculate taxable pay for month
    }
    public Double taxablePay2() {
        return taxablePay *4*12;// create formula to calculate taxable pay for year
    }
    public Double prsi() {
